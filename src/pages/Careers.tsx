    ...
    <div className="min-h-screen bg-white">
      <main className="max-w-7xl mx-auto px-4 py-4 md:px-16 lg:px-24 xl:px-32">
        <div className="text-center mb-12 pt-24">
          <h1 className="text-4xl/17 md:text-5xl/20 font-semibold text-gray-900">Careers</h1>
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20">
            <div className="text-center max-w-md">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-4">Page Under Construction</h2>
              <p className="text-gray-700 mb-6">
                We're working hard to bring you an amazing Careers page. Please check back later for available positions!
              </p>
