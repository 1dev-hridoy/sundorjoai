                        ...
                        <div className="mb-6 flex justify-center">
                            <div className="h-24 w-24 rounded-2xl bg-white/10 backdrop-blur-md flex items-center justify-center border border-white/20 shadow-xl overflow-hidden p-4">
                                {appInfo?.app?.branding?.logo?.png ? (
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-10 h-10 text-white"><path d="M12 2a10 10 0 1 0 10 10 4 4 0 0 1-5-5 4 4 0 0 1-5-5 4 4 0 0 1-5-5 4 4 0 0 1-5-5 4 4 0 0 1-5-5 4 4 0 0 1-5-5" /></svg>
                                )}
                            </div>
                        </div>
                        <h1 className="text-5xl font-bold text-white mb-6 drop-shadow-md">{appInfo?.app?.name || "SundorjoAI"}</h1>
                        <p className="text-xl text-gray-200 max-w-md mx-auto leading-relaxed drop-shadow-sm font-light">
                            Experience the next generation of AI chat. Intelligent, responsive, and beautifully designed.
                        </p>
                    </motion.div>
                </div>
            </div>
                    ...
                    <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center">
                                <input id="remember-me" name="remember-me" type="checkbox" className="h-4 w-4 rounded border-gray-300 text-gray-900 focus:ring-gray-900" />
